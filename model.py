...
config_path = 'convert_weights/uie_medical_base_pytorch/config.json'
checkpoint_path = 'convert_weights/uie_medical_base_pytorch/pytorch_model.bin'
dict_path = 'convert_weights/uie_medical_base_pytorch/vocab.txt'
...
uie_model = build_transformer_model(config_path = config_path, checkpoint_path = checkpoint_path, model = UIE,
                                    with_pool = True)
